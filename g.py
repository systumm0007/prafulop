...
TOKEN = '7277400773:AAGz02Z-e4vbiDsL8CZ_T5IEW8A8cj33_-M'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002243949592
CHANNEL_ID = -1002243949592
error_channel_id = -1002243949592
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀 Attack Sent Successfully! dm to buy @Rohit_ddos 🚀\n\nHost: {target_ip}:{target_port}\nTime: {duration} seconds\nName: {username}*", parse_mode='Markdown')
    except Exception as e:
